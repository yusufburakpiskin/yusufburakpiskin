            ...
            <div class="login-box ptb--100">
                ...
                {{ csrf_field() }}
                    ...
                    <tr>
                        ...
                        <td align="center"><input style="border: 2px solid #eee;" class="au-input au-input--full" type="text" name="email" placeholder="Kullanıcı Adı veya E-Posta" value="{{ Cookie::get('email') !== null ? Cookie::get('email') : '' }}"></td>
                    </tr>
                    <tr>
                        <td><label>Şifre</label></td>
                        <td align="center"><input style="border: 2px solid #eee;" class="au-input au-input--full" type="password" name="password" placeholder="Şifre" value="{{ Cookie::get('password') !== null ? Cookie::get('password') : '' }}"></td>
                    </tr>
                    </table>
                        ...
                        <div class="form-footer text-center mt-5">
                            ...
                            <p class="text-muted">Hesabınız Yoksa? <a href="{{route('register.show')}}">Kayıt Ol</a></p>
                        </div>
                    </div>
